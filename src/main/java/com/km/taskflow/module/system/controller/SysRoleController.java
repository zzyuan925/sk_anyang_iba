...
public class SysRoleController {
    ...
    @OperationLog(module = "角色管理", name = "分页查询角色", type = OperationType.QUERY, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "获取角色详情", type = OperationType.QUERY, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "修改角色", type = OperationType.UPDATE, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "删除角色", type = OperationType.DELETE, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "查询启用角色下拉选项", type = OperationType.QUERY, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "查询角色已绑定权限", type = OperationType.QUERY, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "给角色分配权限", type = OperationType.ASSIGN, recordResult = false)
    ...
    @OperationLog(module = "角色管理", name = "修改角色编码", type = OperationType.UPDATE, recordResult = false)
